...
[[nodiscard]] PamRgbaImage upscale_rgba_nearest(const PamRgbaImage &image,
                                                std::uint32_t integer_scale);
[[nodiscard]] std::uint64_t
apply_palette_zero_transparency(PamRgbaImage &image);
[[nodiscard]] std::uint64_t make_rgba_opaque(PamRgbaImage &image);
