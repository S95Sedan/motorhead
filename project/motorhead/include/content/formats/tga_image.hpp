...
void write_tga_ppm(const TgaImage& image, const std::filesystem::path& output, bool overwrite);
void write_tga_png(const TgaImage& image, const std::filesystem::path& output, bool overwrite);
